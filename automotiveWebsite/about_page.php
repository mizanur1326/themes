...
<!-- breadcrumb_section - start
			...
			<section class="breadcrumb_section text-center clearfix">
				<div class="page_title_area has_overlay d-flex align-items-center clearfix" data-bg-image="<?php echo get_template_directory_uri(); ?>/assets/images/breadcrumb/bg_05.jpg">
				...
				<div class="updown_style_wrap minus_bottom">
					<div class="updown_style">
						<div class="gallery_fullimage" data-aos="fade-up" data-aos-delay="100">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/img_07.jpg" alt="image_not_found">
							<div class="item_content text-white">
								...
								<a class="text_btn text-uppercase" href="#!"><span>Find A Car</span> <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon_02.png" alt="icon_not_found"></a>
							</div>
						</div>

						<div class="gallery_fullimage" data-aos="fade-up" data-aos-delay="300">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/img_08.jpg" alt="image_not_found">
							<div class="item_content text-white">
								<h3 class="item_title text-white">Phasellus porta pulvinar metus</h3>
								<p>
									Phasellus porta pulvinar metus, sit amet bibendum lectus hendrerit vel. Duis ullamcorper, justo quis hendrerit venenatis, purus mi volutpat dui, vel commodo urna eros eget sapien
					...
					<div class="updown_style">
						<div class="gallery_fullimage" data-aos="fade-up" data-aos-delay="100">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/img_01.jpg" alt="image_not_found">
							<div class="item_content text-white">
								<h3 class="item_title text-white">Phasellus porta pulvinar metus</h3>
								<p>
									Phasellus porta pulvinar metus, sit amet bibendum lectus hendrerit vel. Duis ullamcorper, justo quis hendrerit venenatis, purus mi volutpat dui, vel commodo urna eros eget sapien
						...
						<div class="gallery_fullimage" data-aos="fade-up" data-aos-delay="300">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/img_09.jpg" alt="image_not_found">
							<div class="item_content text-white">
								<h3 class="item_title text-white">Phasellus porta pulvinar metus</h3>
								<p>
									Phasellus porta pulvinar metus, sit amet bibendum lectus hendrerit vel. Duis ullamcorper, justo quis hendrerit venenatis, purus mi volutpat dui, vel commodo urna eros eget sapien
